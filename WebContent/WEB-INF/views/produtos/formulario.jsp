...
<body>
	...
	<div class="container" id="cabecalho">
		...
		<p class="navbar-text navbar-right">
			Usuário: <a href="#" class="navbar-link">João da Silva</a>
		</p>
	</div>
	</nav>
	...
	<form action="salvar" method="post">
		<div class="container" id="formulario-produtos">
			<form:errors path="*" />
			<div class="row col-md-12">
				<div class="shadow">
					<div class="over-shadow">
						<div class="col-md-12" id="remocao">
							<div class="row">
								<div class="col-md-6">
									<label>Remoção do corpo no local de falecimento?</label> <select
										id="remocaoLocal">
										<option>Sim</option>
										<option>Não</option>
									</select>
							...
							<div class="row">
								<div class="col-sm-6">
									<label>Local de Remoção</label> <input type="text"
										class="remocao form-control" id="localRemocao" name="localRemocao"
										placeholder="Local de remoção"  disabled/>
								</div>
								<div class="col-sm-6">
									<label>Endereço</label> <input type="text" class="remocao form-control"
										id="enderecoRemocao" name="enderecoRemocao"
										placeholder="endereço de remoção"  disabled/>
								</div>
							</div>
						</div>
					</div>
								...
								<table class="table">
									...
									<tbody>
										<tr>
											...
											<td name="disponibilidadeUrna"><span
										...
										<tr>
											...
											<td><select class="form-control"
												name="dimensaoRevestimento" id="dimensaoRevestimento">
													<option>2,00x0,60x0,40</option>
													<option>1,90x0,60x0,40</option>
											</select></td>
											<td>1</td>
											...
											<td name="disponibilidadeRevestimento"><span
												class="glyphicon glyphicon-ok" aria-hidden="true"></span></td>
										</tr>
									</tbody>
								</table>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="checkbox" value="carroCarreto" checked
										disabled></td>
								...
								<tr>
									<td><input type="checkbox" value="carroEnterro" checked
										disabled></td>
								...
								<tr>
									...
									<td><input type="checkbox" value="sepultamento" checked
										disabled></td>
								...
								<tr>
									<td><input type="checkbox" value="carroCarreto"
										name="outrasTaxas"></td>
									<td colspan="2">Outras</td>
									<td><input type="radio" id="outrasTaxasTipo"
										name="outrasTaxasTipo" disabled>(+)Creditar</input> <input
										type="radio" id="outrasTaxasTipo" name="outrasTaxasTipo"
										disabled>(-)Debitar</input></td>

									<td></td>
									<td><input type="text" disabled id="outrasTaxas"
										name="outrasTaxas"></td>
								</tr>
							</tbody>
			...
			<div class="row col-md-12" id="botoes-navegacao">
				<div class="col-xs-12">
					<input type="button" class="col-xs-1 btn btn-default"
						style="visibility: hidden"><</input> <input type="button"
						class="col-xs-offset-4 col-xs-2 btn btn-default">Cancelar</input>
					<input class="col-xs-offset-4 col-xs-1 btn btn-default" value=">"
...
<script type="text/javascript"
	src="https://raw.github.com/digitalBush/jquery.maskedinput/1.3.1/dist/jquery.maskedinput.min.js"></script>
