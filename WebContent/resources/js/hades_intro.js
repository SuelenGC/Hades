$('#pago').click(function(){
    ...
    var url = window.location.href + '/contratante/formulario?tipoOperacao=1';
...
$('#gratuito').click(function(){
	...
	$('#titulo_caixa').children().remove();
	var titulo = '<h1>Tipo de Contratação</h1>';
	var url = window.location.href + "/contratante/formulario?tipoOperacao=2";
...
$('#registro_de_obito').click(function(){
	/* FINAL */
	var url = window.location.href + "/contratante/formulario?tipoOperacao=3";
...
{
	var url = urlAnterior + "&tipoContratacao=" + valor +"&destinoFinal=1";
	window.location.href = url;
	/* FINAL */
}
...
{
	var url = urlAnterior + "&destinoFinal=" + valor;
	window.location.href = url;
	/* FINAL */
}
